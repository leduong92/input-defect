    ...
    function myFunction() {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                var month;               
                if(curingDate.substring(4,6) == "10")
                {
                     month = "X-";
                }
                else if (curingDate.substring(4,6) == "11")
                {
                     month = "Y-";
                }
                else if (curingDate.substring(4,6) == "12")
                {
                     month = "Z-";
                }
                else
                {
                     month = curingDate.substring(5,6) + "-";
                }       

                lot_no = curingDate.substring(3,4) + month + curingDate.substring(6,8) + ' ' + result.data[0].lot_no.toString();
